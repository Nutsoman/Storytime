...
public enum Symbol {
	...
	TITLETYPE(new PhraseList(
			...
			"#BOOKSTART_1# #VERB_PAST# #NOUNS_BASIC_PLURAL#",
			"#VERB_PRES# #FOOD_PRODUCT#",
			"#BOOKTYPE# #NAMES_MALE_FIRST# the #VERB_PRES#",
			...
			"#ADJ# #NOUNS_BASIC#-#NOUNS_BASIC_PLURAL#",
			"#ADJ# #MC_BLOCK#",
			"#PRONOUN# #VERB_PAST#",
			"#PRONOUN# #VERB_PAST# - It Was #ADJ#",
